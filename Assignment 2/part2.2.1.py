...
#three workers reaches enemy's home base
#or capture 14 or more enemy's workers
...
def Offensive2(agent, matrix):
	...
	return 10*int(Defensive2(agent, matrix)) - ret/7 + random.random()
